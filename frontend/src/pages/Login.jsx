...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast({ title: "Успешен вход!", description: "Добре дошли в RecipeShare." });
            navigate('/');
        } catch (err) {
            ...
            <Card className="w-full max-w-md shadow-xl border-t-4 border-t-red-600">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <CardFooter className="flex flex-col gap-4">
                        <Button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-6">Влез</Button>
